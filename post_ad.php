...
<head>
    ...
    <style>
        ...
        .home:focus,.electronics:focus,.home:active,.electronics:active,.cars:focus,.cars:active {
            outline: none !important;
            box-shadow: none;
        }
        .home:hover,.electronics:hover,.cars:hover {
            transform: scale(1.5);
        }
        .header {
            font-family: cursive;
...
<body>
   <div class="topnav">
          ...
          <a class= "out" href="login.php">Logout</a></div> <br>
   <form action="post_ad.php" method="post"><div class = "category text-center">
