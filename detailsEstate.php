...
<body>
  <?php include "db.php";
include "estateServer.php";
session_start();
$q="SELECT u.first_name || u.last_name, u.email, u.phone from users u join estate e on(e.email=u.email)";
$res=mysqli_query($connection,$q) or exit("Error in query");
$row=mysqli_fetch_assoc($res) or exit("error in query");
?>
   <div class="topnav">
