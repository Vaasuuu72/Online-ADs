    ...
    <div class="details">
        <table>
            <tr>
                ...
                <td><div class="input"><h2><b><?php echo $details['firstName']," ",$details['lastName']; ?></b></h2></div></td>
            </tr>
            <tr>
                <td><h2><b>MOBILE NUMBER: </b></h2></td>
                <td><div class="input"><h2><b><?php echo $details['phone']; ?></b></h2></div></td>
            </tr>
            <tr>
