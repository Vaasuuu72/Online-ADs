...
<body>
   <div class="topnav"><a class="active" href="home.php">Home</a>
    ...
    <div class="text-center header"><h1>ESTATE AD</h1></div><div class="row"> 
    <?php
    $q="SELECT * from estate";
    ...
    <img class="card-img-top" src="electronics.png" alt="Card image cap" style="width:100%;height:59%">
    <div class="card-body"><h2 class="card-title"><?php echo $row['purpose']; ?></h2>
      <p class="card-text">Type:<?php echo " ".$row['type']; ?></p>
      <p class="card-text">BHK:<?php echo " ".$row['bhk']; ?></p>
      <p class="card-text">Price:<?php echo " ".$row['price']; ?></p>
      <p class="card-text">City:<?php echo " ".$row['city']; ?></p>
      <p class="card-text">Building:<?php echo " ".$row['build']; ?></p>
      <p class="card-text"><?php echo "BuildArea: ".$row['area']; ?></p>
      <p class="card-text">Title:<?php echo " ".$row['adTitle']; ?></p>
      <p class="card-text">Description:<?php echo " ".$row['desc']; ?></p>
     <a href="detailsEstate.php" class="btn btn-primary contact">Contact Here</a>
    </div></div></div></div><?php } ?>
 </div>
</body>
</html>